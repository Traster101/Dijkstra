...
// data = a function returning the content (actually HTML)
	...
	Vue.component('resource-display', {
		...
		<div style="margin-top: -13px">
			...
			<br><br>
			<span v-if="tmp[layer].showGainPerSec && player[layer].time != null && player[layer].time.gt(new Decimal(0))">Your current gain/sec since this last row reset is {{formatWhole(tmp[layer].resetGain.div(player[layer].time))}}<br></span>
