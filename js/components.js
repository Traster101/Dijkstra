...
// data = a function returning the content (actually HTML)
	...
	Vue.component('resource-display', {
		...
		<div style="margin-top: -13px">
			...
			<br><br>
			<span v-if="tmp[layer].resetGain != null">Your current gain/sec since this last row reset is {{formatWhole(tmp[layer].resetGainPerSecond)}} ({{formatWhole(tmp[layer].resetGainPerSecondMax)}} max)<br></span>
